...
typedef struct
{
	...
	uint8_t EXTI_Line_Number ;     	//Specifies the EXTI_Line_Number
	...
	uint8_t EXTI_Pin_Number;           //Specifies the EXTI_Pin_Number that receives external interrupt
...
//@EXTI_Trigger_Define.............. OPTION EXTI_LOW_LEVEL  & EXTI_Rising_Falling_Trigger Not available in INT2
#define EXTI_LOW_LEVEL                    0
#define EXTI_Rising_Falling_Trigger       1
#define EXTI_Falling_Trigger              2
#define EXTI_Rising_Trigger       		  3
