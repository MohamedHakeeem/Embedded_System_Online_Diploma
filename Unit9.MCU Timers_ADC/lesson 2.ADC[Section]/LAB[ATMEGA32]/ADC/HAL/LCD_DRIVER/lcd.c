...
void LCD_WRITE_Number_1digit(unsigned char Number)
{
...
void LCD_WRITE_Number_Ndigit(uint32_t N_Digit_Number,uint8_t N)
{
uint32_t REM=0, Num=0;
uint8_t Digits[N];
int i=0, j=0;
...
for(i=0; i<N; i++)LCD_WRITE_Number_1digit(Digits[i]);
